      ...
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '1.2rem', maxWidth: '800px', margin: '0 auto' }}>
            Official directory of Engineering, Pharmacy, and Management institutions affiliated with JNTU-GV.
          </p>
        </div>
              ...
              {['All', 'Engineering', 'Pharmacy', 'Management'].map((type) => (
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer',
                    transition: 'all 0.2s',
                    backgroundColor: activeCategory === type ? 'var(--primary)' : 'transparent',
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ backgroundColor: 'var(--primary)', color: 'white' }}>
                  ...
                  <th style={{ padding: '1.25rem 1.5rem', textAlign: 'left', fontWeight: '800' }}>College Name & Location</th>
                  <th style={{ padding: '1.25rem 1.5rem', textAlign: 'center', width: '150px', fontWeight: '800' }}>Category</th>
                  <th style={{ padding: '1.25rem 1.5rem', textAlign: 'center', width: '150px', fontWeight: '800' }}>Website</th>
                </tr>
              </thead>
              <tbody>
                {filteredColleges.length > 0 ? (
                  filteredColleges.map((college, index) => (
                    <tr key={college.code} style={{ 
                      ...
                      <td style={{ padding: '1.5rem', textAlign: 'center' }}>
                        <span style={{ backgroundColor: '#f1f5f9', color: 'var(--primary)', padding: '0.4rem 0.8rem', borderRadius: '8px', fontWeight: '800', fontSize: '0.9rem' }}>
                          {college.code}
                        </span>
                      </td>
                      ...
                      <td style={{ padding: '1.5rem', textAlign: 'center' }}>
                        ...
                        >
                          Visit Site <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
                        </a>
                      </td>
                    </tr>
                  ))
                  ...
                  <tr>
                    <td colSpan={4} style={{ padding: '5rem', textAlign: 'center', color: 'var(--text-muted)' }}>
                      ...
                      <p style={{ fontSize: '1.1rem', fontWeight: '600' }}>No affiliated institutions found matching your search.</p>
                      <button onClick={() => {setSearchTerm(''); setActiveCategory('All');}} style={{ color: 'var(--primary)', background: 'none', border: 'none', textDecoration: 'underline', cursor: 'pointer', marginTop: '1rem' }}>Reset directory</button>
                    </td>
                  </tr>
                )}
              </tbody>
