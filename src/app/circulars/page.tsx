      ...
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '1.2rem', maxWidth: '800px', margin: '0 auto' }}>
            Official directives, policy updates, and administrative notices issued by the Directorate of Academic Audit and Planning.
          </p>
        </div>
        ...
        <div className="card" style={{ padding: '2.5rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem', flexWrap: 'wrap', gap: '1.5rem' }}>
            ...
            <div style={{ backgroundColor: 'rgba(55, 10, 104, 0.05)', color: 'var(--deep-purple)', padding: '0.5rem 1rem', borderRadius: '12px', fontSize: '0.9rem', fontWeight: '700' }}>
          ...
          {loading ? (
            <div style={{ textAlign: 'center', padding: '4rem 2rem' }}>
              ...
              <p style={{ color: 'var(--text-muted)', fontWeight: '500' }}>Fetching official notices...</p>
            </div>
          ) : error ? (
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ backgroundColor: 'var(--primary)', color: 'white' }}>
                    <th style={{ padding: '1.25rem 1.5rem', textAlign: 'center', fontWeight: '700', width: '15%', fontSize: '0.9rem', textTransform: 'uppercase' }}>Date</th>
                    <th style={{ padding: '1.25rem 1.5rem', textAlign: 'left', fontWeight: '700', width: '65%', fontSize: '0.9rem', textTransform: 'uppercase' }}>Circular Title</th>
                    <th style={{ padding: '1.25rem 1.5rem', textAlign: 'center', fontWeight: '700', width: '20%', fontSize: '0.9rem', textTransform: 'uppercase' }}>Action</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredCirculars.length > 0 ? (
                    filteredCirculars.map((circ, index) => (
                      <tr key={circ.id} style={{ borderBottom: '1px solid var(--border)', backgroundColor: index % 2 === 0 ? 'white' : '#fcfcfc', transition: 'background-color 0.2s' }}>
                        <td style={{ padding: '1.5rem' }}>
                          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundColor: '#f1f5f9', borderRadius: '12px', padding: '0.5rem', border: '1px solid #e2e8f0' }}>
                            <span style={{ fontSize: '1.25rem', fontWeight: '800', color: 'var(--primary)', lineHeight: '1' }}>{circ.day}</span>
                            <span style={{ fontSize: '0.7rem', fontWeight: '700', color: '#64748b', textTransform: 'uppercase', marginTop: '0.25rem' }}>{circ.month} {circ.year}</span>
                          </div>
                        </td>
                    ...
                    <tr>
                      <td colSpan={3} style={{ padding: '4rem', textAlign: 'center', color: 'var(--text-muted)' }}>No DAAP circulars found matching your search.</td>
                    </tr>
                  )}
                </tbody>
              </table>
